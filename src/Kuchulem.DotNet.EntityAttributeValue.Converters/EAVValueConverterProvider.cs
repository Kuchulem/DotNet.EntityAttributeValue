...
namespace Kuchulem.DotNet.EntityAttributeValue.Converters
{
    public class EAVValueConverterProvider : IEAVValueConverterProvider
    {
        ...
        public EAVValueConverterBase<T> GetConverter<T>(EAVValueKind valueKind)
        {
        ...
        public IEAVValueConverterProvider Register<T>(EAVValueKind valueKind, EAVValueConverterBase<T> converter)
        {
            var type = typeof(T);
        ...
        public bool TryGetConverter<T>(EAVValueKind valueKind, out EAVValueConverterBase<T>? converter)
        {
            var type = typeof(T);
            var key = (type, valueKind);
            converter = null;
            ...
            converter = genericConverters[key] as EAVValueConverterBase<T>;
        ...
        public bool TryGetConverter<T>(IEAVAttribute attribute, out EAVValueConverterBase<T>? converter)
        {
            ...
            converter = attributeConverters[key] as EAVValueConverterBase<T>;
